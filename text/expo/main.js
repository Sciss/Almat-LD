...
var $author$project$Main$Bibliography = {$: 'Bibliography'};
var $author$project$Main$Introduction = {$: 'Introduction'};
var $author$project$Main$Overview = {$: 'Overview'};
var $author$project$Main$Subgraph = function (a) {
	return {$: 'Subgraph', a: a};
};
var $author$project$Main$nodeFromUrl = function (s) {
	var _v0 = s.fragment;
	if (_v0.$ === 'Nothing') {
		return $author$project$Main$Overview;
	} else {
		switch (_v0.a) {
			case 'Overview':
				return $author$project$Main$Overview;
			case 'Introduction':
				return $author$project$Main$Introduction;
			case 'Bibliography':
				return $author$project$Main$Bibliography;
			default:
				var str = _v0.a;
				return $author$project$Main$Subgraph(str);
		}
	}
};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{
				key: key,
				selectedNode: $author$project$Main$nodeFromUrl(url),
				url: url
			},
...
var $author$project$Text$addOtherConnections = F2(
	function (entry, l) {
		var connectedTitles = A2(
			$elm$core$List$map,
			function ($) {
				return $.title;
			},
			A2(
				...
				function (e) {
					return A2($elm$core$List$member, entry.title, e.neighbors);
				},
				l));
		var allNeighbors = $elm$core$Set$toList(
			$elm$core$Set$fromList(
				_Utils_ap(entry.neighbors, connectedTitles)));
		return _Utils_update(
			entry,
			{neighbors: allNeighbors});
	});
var $author$project$Text$completeNeighbors = function (lst) {
	return A2(
		$elm$core$List$map,
		function (e) {
			return A2($author$project$Text$addOtherConnections, e, lst);
		},
		lst);
};
...
var $author$project$Text$entries = $author$project$Text$completeNeighbors(
	_List_fromArray(
		[
			{
			content: A2(
			...
			neighbors: _List_fromArray(
				['Computation', 'Contingency', 'Information']),
			...
			keywords: _List_Nil,
			neighbors: _List_fromArray(
				['Computation', 'System', 'Synchronization', 'Affect']),
			title: 'Information'
		},
			{
			content: A2(
			...
			keywords: _List_Nil,
			neighbors: _List_fromArray(
				['Computation', 'Contingency', 'System']),
			title: 'Recursivity'
		},
			{
			content: A2(
			...
			keywords: _List_Nil,
			neighbors: _List_fromArray(
				['Synchronization', 'Contingency', 'Body']),
			title: 'Affect'
		},
			{
			content: A2(
...
var $author$project$Main$pagetitle = function (t) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('pagetitle')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$title = 'Almat: Affective Apparatuses';
var $author$project$DrawGraph$CustomNode = F2(
	function (rank, name) {
				...
				return {
					...
					node: {
						...
						label: A2(
							...
							node.id,
							A2(
								$author$project$DrawGraph$CustomNode,
...
var $author$project$DrawGraph$linkElement = F2(
	function (graph, edge) {
		var retrieveEntity = A2(
			...
			$elm$core$Maybe$withDefault(
				A2(
					$gampleman$elm_visualization$Force$entity,
					0,
					A2($author$project$DrawGraph$CustomNode, 0, ''))),
			$elm$core$Maybe$map(
				A2(
					$elm$core$Basics$composeR,
					function ($) {
...
var $author$project$DrawGraph$nodeElement = F2(
	function (selectedString, node) {
		var thisNode = node.label.value.name;
		var weight = _Utils_eq(selectedString, thisNode) ? $elm_community$typed_svg$TypedSvg$Types$FontWeightBolder : $elm_community$typed_svg$TypedSvg$Types$FontWeightNormal;
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$rx(110),
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$ry(22),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm_community$typed_svg$TypedSvg$Attributes$xlinkHref('#' + thisNode),
									$elm_community$typed_svg$TypedSvg$Attributes$fontSize(
									$elm_community$typed_svg$TypedSvg$Types$Em(1.2)),
...
var $author$project$DrawGraph$viewGraph = F4(
	function (_v0, selectedString, _v1, model) {
		var w = _v0.a;
		var h = _v0.b;
		var boxWidth = _v1.a;
		var boxHeight = _v1.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						$author$project$DrawGraph$linkElement(model),
					...
					A2(
						$elm$core$List$map,
						$author$project$DrawGraph$nodeElement(selectedString),
						$elm_community$graph$Graph$nodes(model)))
				]));
	});
var $author$project$DrawGraph$view = F5(
	function (graph, selectedString, _v0, _v1, dist) {
		var width = _v0.a;
		var height = _v0.b;
		var boxWidth = _v1.a;
		var boxHeight = _v1.b;
...
var $author$project$Main$viewOverview = function () {
	var graph = A5(
		$author$project$DrawGraph$view,
		$author$project$Text$contentGraph,
		'Overview',
		_Utils_Tuple2(1200, 700),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$pagetitle('Overview')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('nav-list-overview')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#Overview')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#Introduction')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#Bibliography')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Bibliography')
									]))
							]))
					])),
				A2(
...
var $author$project$Content$stringAsGraphElement = function (str) {
	return {title: str};
};
var $author$project$Content$makeSubGraph = function (entry) {
	if ($elm$core$List$isEmpty(entry.neighbors)) {
		return A2(
			$elm_community$graph$Graph$fromNodeLabelsAndEdgePairs,
			_List_fromArray(
				[
					$author$project$Content$stringAsGraphElement(entry.title)
				]),
			_List_Nil);
	} else {
		var pairs = A2(
			$elm$core$List$map,
			function (n) {
				return _Utils_Tuple2(0, n);
			},
			A2(
				$elm$core$List$range,
				1,
				$elm$core$List$length(entry.neighbors)));
		return A2(
			$elm_community$graph$Graph$fromNodeLabelsAndEdgePairs,
			A2(
				$elm$core$List$map,
				$author$project$Content$stringAsGraphElement,
				A2($elm$core$List$cons, entry.title, entry.neighbors)),
			pairs);
	}
};
var $author$project$Text$subGraphs = $elm$core$Dict$fromList(
	A2(
		$elm$core$List$map,
		function (e) {
			return _Utils_Tuple2(
				e.title,
				$author$project$Content$makeSubGraph(e));
		},
		$author$project$Text$entries));
var $author$project$Main$viewSubgraph = function (subName) {
	var subgraph = A2(
		$elm$core$Maybe$withDefault,
		...
		A2(
			...
			function (g) {
				return A5(
					...
					g,
					subName,
					_Utils_Tuple2(540, 400),
					_Utils_Tuple2(600, 500),
					150);
			},
			A2($elm$core$Dict$get, subName, $author$project$Text$subGraphs)));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$pagetitle(subName)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('metadata')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('small-nav')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('subgraph')
									]),
								_List_fromArray(
									[subgraph]))
							])),
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$Text$lorem)
					]))
			]));
};
var $author$project$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				function () {
				var _v0 = model.selectedNode;
				if (_v0.$ === 'Subgraph') {
					var s = _v0.a;
					return $author$project$Main$viewSubgraph(s);
				} else {
					return $author$project$Main$viewOverview;
				}
			}()
			]),
		title: 'Test'
